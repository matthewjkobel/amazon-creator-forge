  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-white hover:shadow-glow transform hover:scale-105 transition-spring font-semibold",
        coral: "bg-coral text-coral-foreground hover:bg-coral/90 shadow-soft hover:shadow-medium",
        premium: "gradient-card border border-primary/20 text-primary hover:shadow-glow hover:bg-primary hover:text-primary-foreground transition-spring",
      },
      size: {
