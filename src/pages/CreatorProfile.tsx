      ...
      try {
        ...
        if (creator && !error) {
          ...
          form.reset({
            ...
            featuredContentUrl2: (creator as any).featured_content_url_2 || "",
            featuredContentUrl3: (creator as any).featured_content_url_3 || "",
            featuredContentDesc1: (creator as any).featured_content_desc_1 || "",
            featuredContentDesc2: (creator as any).featured_content_desc_2 || "",
            featuredContentDesc3: (creator as any).featured_content_desc_3 || "",
  ...
  const autoSaveToDatabase = useCallback(async (formData: ProfileFormData) => {
    ...
    try {
      ...
      const updateData: any = {
        ...
        featured_content_url_2: formData.featuredContentUrl2,
        featured_content_url_3: formData.featuredContentUrl3,
        featured_content_desc_1: formData.featuredContentDesc1,
        featured_content_desc_2: formData.featuredContentDesc2,
        featured_content_desc_3: formData.featuredContentDesc3,
  ...
  const onSubmit = async (data: ProfileFormData) => {
    ...
    try {
      ...
      const updateData: any = {
        ...
        featured_content_url_2: data.featuredContentUrl2,
        featured_content_url_3: data.featuredContentUrl3,
        featured_content_desc_1: data.featuredContentDesc1,
        featured_content_desc_2: data.featuredContentDesc2,
        featured_content_desc_3: data.featuredContentDesc3,
